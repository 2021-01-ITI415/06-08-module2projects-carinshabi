...
public class Layout : MonoBehaviour
{
    ...
    public Vector2 multiplier; // The offset of the table's center
    // SlotDef references
    public List<SlotDef> slotDefs; // All the SlotDefs for Row0 - Row3
    public SlotDef drawPile;
    public SlotDef discardPile;
    // This holds all of the possible names for the layer set by layersID
    ...
    public void ReadLayout(string xmlText)
    {
        ...
        for (int i = 0; i < slotsX.Count; i++)
        {
            ...
            // Various attributes are parsed into numerical value
